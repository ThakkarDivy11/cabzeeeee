                ...
                <div className="mt-20 flex justify-center pb-20">
                    <div className="bg-white/50 backdrop-blur-sm px-10 py-5 rounded-full border border-navy/5 flex items-center space-x-6 shadow-sm">
                        <div className="flex items-center gap-3">
                            <div className="w-2.5 h-2.5 bg-navy rounded-full animate-pulse"></div>
                            <div className="w-2.5 h-2.5 bg-sky-blue rounded-full animate-pulse delay-100"></div>
                        </div>
                        <p className="text-[10px] font-black text-navy/40 uppercase tracking-[0.5em]">Reporting Subsystem: Active Data Ingestion established</p>
                    </div>
                </div>
            </main>
        </div>
