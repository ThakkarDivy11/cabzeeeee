...
const LiveMapBooking = () => {
    ...
    return (
        <div className="h-screen w-full bg-soft-white overflow-hidden flex">
            <Sidebar
                isOpen={sidebarOpen}
                    ...
                    <div className="flex flex-col gap-2 max-w-md mx-auto">
                        <div className="bg-white rounded-2xl shadow-2xl p-4 pointer-events-auto flex items-center justify-between border border-navy/5">
                            <div className="flex items-center">
                                ...
                                <h1 className="text-lg font-bold text-navy whitespace-nowrap">Book your ride</h1>
                            </div>
                            <button onClick={() => setSidebarOpen(true)} className="p-2 lg:hidden rounded-xl bg-navy/5 text-navy hover:bg-navy hover:text-soft-white border border-navy/10 transition-all duration-300 transform active:scale-95 shadow-sm">
